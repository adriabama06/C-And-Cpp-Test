...
void Util::toChar(char* destination, float f, int presision)
{
...
void Util::joinChars(char* destination, char* char1, char* char2)
{
    ...
    for(size_t i = 0; i < lenChar1; i++)
    {
        temp[i] = char1[i];
    }
    for(size_t i = 0; i < lenChar2; i++)
    {
